...
const styleMap = {
    base: {
        textIcon: null,
        datetime: `text-slate-800 ${styles.datetime}`,
        primaryText: `text-slate-500 ${styles.primaryText}`,
        container: `bg-gray-50 shadow-sm ${styles.container}`
    },
    onSelect: {
        textIcon: 'bg-indigo-100 text-indigo-600',
        datetime: `text-indigo-700 ${styles.datetime}`,
        primaryText: `text-indigo-600 ${styles.primaryText}`,
        container: `ring-1 ring-indigo-400 shadow-lg bg-indigo-50/70 ${styles.container}`
    }
};
