...
import { TransactionListProps, ListItem } from "../commons/types";
                            ...
                            <li ref={ref} key={item.id} className="relative overflow-hidden border-b border-gray-200 dark:border-gray-700 last:border-b-0">
                              ...
                              >
                                ...
                                <div className="flex-grow pr-2 pl-4 min-w-4">
                                  <h3 className="font-semibold text-[15px] text-gray-800 dark:text-gray-200 line-clamp-2 break-all">{item.title}</h3>
                                </div>
