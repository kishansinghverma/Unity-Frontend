...
const HeaderFC: FC = () => (
  <div className="flex items-center gap-1">
    ...
    >
      <Unlock size={14} strokeWidth={2.5} className="text-gray-600 transition-transform duration-200 group-hover:-translate-y-0.5 group-hover:rotate-12 group-hover:text-gray-900" />
      Unlock PDF
    </button>
